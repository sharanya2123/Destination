...
render(){
    ...
    const filtersearchResults = destinationList.filter(eachItem =>
    ...
    return(
        ...
        <input type="search" className="search-input" placeholder="Search" value={searchInput} onChange={this.SearchUserInput} />
